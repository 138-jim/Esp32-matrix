...
echo ""
echo "4. Open web interface (accessible over LAN):"
echo "   From this Pi: http://localhost:8080"
echo "   From LAN:     http://$(hostname -I | awk '{print $1}'):8080"
echo "   Or hostname:  http://$(hostname).local:8080"
echo ""
